-- From https://raw.githubusercontent.com/amoudgl/short-jokes-dataset/master/data/reddit-cleanjokes.csv and some manual cleaning
...
,('What did the bee use to dry off after swimming? A *bee*ch towel. What did the bee use to get out the tangles? A honeycomb.')
...
,('"Hey! The dog you sold me yesterday just fell over and died today!" "Huh, strange. He''s never done that before."')
...
,('What do you get when you play a Frank Sinatra record at twice the speed? "Shrank Sinatra"')
...
,('What''s Sam Smith''s favorite type of nut? It''s an alllllllllmond')
